...
class Notific1 extends StatefulWidget {
  Notific1({Key? key}) : super(key: key);

  @override
  _Notific1State createState() => _Notific1State();
}

class _Notific1State extends State<Notific1> {
